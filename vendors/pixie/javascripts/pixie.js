...
(function($) {
  ...
  var imageDir = "vendors/pixie/images/pixie/";
  ...
  var tools = {
    ...
    dropper: {
      ...
      mousedown: function() {
        ...
        $('.toolbar .tool').removeClass("active").eq(0).addClass("active");
      }
    },
  ...
  var ColorPicker = function(color) {
    return $('<input maxlength="6" value="'+(color || '')+'"></input>')
           .addClass('color').change(function(){
           })
           .colorPicker({"dir":"vendors/pixie/images/jqcolor/"});
  };
  ...
  $.fn.pixie = function(options) {
    ...
    return this.each(function() {
      var toolbars = $(div).addClass('toolbars');
      ...
      var layerMenu = $(div).addClass('toolbar');
      ...
      var secondaryColorPicker = ColorPicker('FFFFFF');
      primaryColorPicker.change(function(){ canvas.addSwatch('#'+$(this).val()); })
      primaryColorPicker.change(function(){ canvas.addSwatch('#'+$(this).val()); })
      ...
      $.each(["#000", "#FFF", "#F00", "#0F0", "#00F", "#ffff00"], function(i, color) {
